        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-12">
            ...
            <div className="lg:col-span-1">
              <div className="mb-8">
                <h3 className="text-2xl font-light mb-2">SHOWMINE</h3>
              </div>
              <div>
                <h4 className="text-lg font-medium mb-4">Join our newsletter</h4>
                <p className="text-gray-400 mb-6 leading-relaxed">
                  Sign up for our newsletter below and be the first to hear about new updates and exciting e-commerce topics.
                </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div>
                  ...
                  <ul className="space-y-3 text-gray-400">
                    <li><a href="/consulting" className="hover:text-white transition-colors">E-commerce Consulting</a></li>
                    <li><a href="/logistics" className="hover:text-white transition-colors">Logistics Solutions</a></li>
                    <li><a href="/optimization" className="hover:text-white transition-colors">Performance Optimization</a></li>
                    <li><a href="/international" className="hover:text-white transition-colors">International Expansion</a></li>
                  </ul>
                </div>
                <div>
                ...
                <div>
                  ...
                  <ul className="space-y-3 text-gray-400">
                    ...
                    <li><a href="/resources" className="hover:text-white transition-colors">Downloads</a></li>
                  </ul>
                </div>
                <div>
          ...
          <div className="pt-8 border-t border-gray-800">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-gray-400 text-sm">
                ©2024 Showmine GmbH - All Rights Reserved
              </p>

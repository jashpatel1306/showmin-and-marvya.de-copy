...
const testimonials = [
  ...
  {
    id: 3,
    text: "Showmine team is very customer-focused, fast, and reliable. We had some special requests and they went above and beyond to find solutions.",
...
const categories = ["All", "E-commerce", "Print Solutions", "Customer Support", "Business Growth"]

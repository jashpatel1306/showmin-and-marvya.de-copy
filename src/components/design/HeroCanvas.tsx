...
const HeroCanvas = ({ imageSrc }: HeroCanvasProps) => (
  <motion.div
  ...
  >
    {/* Comment bubble - positioned above canvas */}
    <CommentBubble />

    <div className="relative overflow-visible">
      {/* Label */}
      <div className="px-3 py-3">
        <span className="text-xs font-medium text-muted-foreground">Design canvas</span>
      </div>

...
export function DarkVeil({
  ...
  useEffect(() => {
    ...
    // Quad geometry covering whole clip space
    ...
    const render = () => {
      ...
      if (uHueShift) gl.uniform1f(uHueShift, hueShift);
      if (uNoise) gl.uniform1f(uNoise, noiseIntensity);
      if (uScan) gl.uniform1f(uScan, scanlineIntensity);
      if (uScanFreq) gl.uniform1f(uScanFreq, scanlineFrequency);
      if (uWarp) gl.uniform1f(uWarp, warpAmount);

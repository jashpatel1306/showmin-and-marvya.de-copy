...
import projectVoiceflow from "@/assets/project-voiceflow.png";
...
import bgBlueOrange from "@/assets/bg-blue-orange.jpg";
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-20 text-center">
        <motion.h1
          className="text-6xl md:text-8xl font-display font-medium tracking-tight text-foreground"

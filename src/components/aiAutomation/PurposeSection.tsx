...
const features = [
    {
      title: "Build around your existing stack",
      description:
        "We assess the tools you already use, review your website setup, and identify where time and effort are being lost.",
    },
    {
      title: "Design clear and controlled workflows",
      description:
        "We create automation and AI flows that are simple to understand, easy to review, and built with defined boundaries and safeguards.",
    },
    {
      title: "Iterate in manageable steps",
      description:
        "We launch a focused first version, gather feedback, and expand gradually based on what delivers real value.",
    },
  ];
...
const PurposeSection = () => (
  <section className="mx-auto max-w-[1240px] px-4 py-7 md:py-12">
    ...
    <div className="mb-10 flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
      ...
      >
        We focus on low risk, useful changes first. That might be handling form submissions more neatly, or helping visitors get simple answers quickly.
      </motion.p>
    </div>
    ...
    <motion.div
      ...
      viewport={{ once: true }}
      transition={{ duration: 0.5 }}
      className="rounded-xl bg-purple-500 p-3 pb-0"
    >
    ...
    >
      ...
      Thinking about AI/automation but not sure where to start?
      </h2>
      <a
        href="#get-started"

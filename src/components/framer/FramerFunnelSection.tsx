...
import centralIcon from "@/assets/Framer/logo.png";
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="text-center mb-10 md:mb-16 space-y-4 md:space-y-5">
                    <h2 className="section-title text-foreground">
                        Plug Framer into your stack

                    </h2>
                    <p className="text-muted-foreground text-sm sm:text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
                        We connect Framer to your existing marketing stack – analytics, forms, CRM, payments, and automation – so your site fits the way your team already works
                    </p>
                </div>
...
export default FramerFunnelSection;

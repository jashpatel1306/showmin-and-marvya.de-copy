...
import projectBgOrangeBlue from "@/assets/Framer/project-bg-ss.jpg";
import projectScreenshot from "@/assets/Framer/project-ss.png";
    ...
    <section className="max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-16 bg-background">
      ...
      <div className="space-y-8 mb-14">
          <ProjectCard
            ...
            category="E-commerce"
            flag="🇬🇧"
            description="Migrated Consensus’ 5,000+ page site from complex WordPress to an easy-to-manage Framer build."
            testimonial=""

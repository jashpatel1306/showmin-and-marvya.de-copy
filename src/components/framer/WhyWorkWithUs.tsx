...
const reasons: ReasonItem[] = [
    {
      title: "Design and development aligned",
      description:
        "Our designers and developers collaborate directly in Framer, ensuring layouts, interactions, and implementation stay consistent from concept to launch.",
    },
    {
      title: "Built for conversion, not just aesthetics",
      description:
        "We focus on clear messaging, structure, and user journeys so every Framer page supports your marketing goals—not just visual appeal.",
    },
    {
      title: "Ongoing support and optimization",
      description:
        "After launch, we can help refine pages, test new sections, and maintain performance as your campaigns and products grow.",
    },
  ];
    ...
    return (
        <section className="w-full bg-gradient-to-b from-secondary to-background py-16 md:py-24">
            <div className="mx-auto max-w-3xl px-4 md:px-6">
                ...
                Why work with a Framer agency like Showmine
                </h2>

...
import elementorDashboardImg from "@/assets/Framer/work-ss.jpeg";
import { useEffect, useRef } from "react";
import elementorLogo from "@/assets/Framer/logo.png";
        ...
        <div className="min-h-screen bg-background overflow-hidden">
            ...
            <section className="relative w-full">
                ...
                <div className="relative z-10 flex flex-col items-center pt-32 sm:pt-40 px-4">
                    ...
                    >
                        Framer agency for high-converting sites
                    </motion.h1>
                    ...
                    >
                        We design and build Framer marketing websites and landing pages for teams that need to move quickly. The result is polished, interactive pages that look premium, load fast, and are simple for your team to update, experiment with, and launch campaigns on.
                    </motion.p>

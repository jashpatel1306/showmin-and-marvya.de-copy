...
import elementorDashboardImg from "@/assets/Elementor/elementor_project-ss.png";
import { useEffect, useRef } from "react";
import elementorLogo from "@/assets/Elementor/elementor-icon.png";
        ...
        <div className="min-h-screen bg-background overflow-hidden">
            ...
            <section className="relative w-full">
                ...
                <div className="relative z-10 flex flex-col items-center pt-32 sm:pt-40 px-4">
                    ...
                    >
                        Migrate from Elementor without losing your site
                    </motion.h1>
                    ...
                    >
                        If your Elementor site has become slow, cluttered, or difficult to manage, we can step in. We start by auditing and stabilizing your current setup, improving key templates and performance where it matters most. When the time is right, we can then migrate you to a cleaner, more structured Webflow or WordPress build designed for long-term stability and easier updates.                    </motion.p>

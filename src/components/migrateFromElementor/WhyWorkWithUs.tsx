...
const reasons: ReasonItem[] = [
    {
      title: "Expertise across Elementor and modern platforms",
      description:
        "We work with Elementor, Gutenberg, WordPress, Webflow, and Framer, giving us a broad perspective to recommend the solution that genuinely supports your long-term goals.",
    },
    {
      title: "Stabilize first, then evolve",
      description:
        "We focus on fixing and improving your current site before recommending a full rebuild, so you’re not pushed into a major transition prematurely.",
    },
    {
      title: "Straightforward advice on your next move",
      description:
        "We provide clear, honest guidance on whether to refine Elementor or invest in a new build—along with practical insight into costs, risks, and timelines.",
    },
  ];
    ...
    return (
        <section className="w-full bg-gradient-to-b from-secondary to-background py-16 md:py-24">
            <div className="mx-auto max-w-3xl px-4 md:px-6">
                ...
                Why work with Showmine on Elementor migration

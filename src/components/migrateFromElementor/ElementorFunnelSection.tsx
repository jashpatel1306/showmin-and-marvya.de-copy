...
import centralIcon from "@/assets/Elementor/elementor-icon.png";
        ...
        <section className="max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-16">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="text-center mb-10 md:mb-16 space-y-4 md:space-y-5">
                    ...
                    Use Elementor as a stepping stone, not a dead end

                    </h2>
                    <p className="text-muted-foreground text-sm sm:text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
                    We help you maximize the performance and usability of your current Elementor site—while creating a clear path toward a cleaner, more sustainable long-term setup, whether that remains on WordPress or transitions to Webflow or another modern platform.
                    </p>
                </div>
...
export default ElementorFunnelSection;

...
import projectBgOrangeBlue from "@/assets/GoDaddy/project-bg.jpg";
    ...
    <section className="max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-16 bg-background">
      ...
      <div className="space-y-8 mb-14">
          <ProjectCard
            ...
            category="E-commerce"
            flag="🇬🇧"
            description="Rebrand and new website for a long-standing service business."
            testimonial="They have produced an amazing new website for us, updated our Logo and appearance to a very up to date and clean look. The site is beyond what we could ever have expected, it is clear easy to follow and easy for a prospect to work with."
            avatarImage={avatarStuart}
            clientName="Philip Gilkes"
            clientRole="Owner at Kingstar Services"
          />
      </div>
...
export default ElementorProjects;

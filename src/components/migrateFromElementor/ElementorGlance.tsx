...
import elementorGlance from "@/assets/Elementor/elementor-icon.png";
...
const cards = [
    {
        ...
        description:
            "Migrating small business and service-based websites from GoDaddy, redesigning marketing sites, and moving landing pages or simple content sites into Webflow or Framer.",
        borderClass: "border-r border-b",
    },
    {
        title: "Best for teams that",
        description:
            "Chose GoDaddy for speed and affordability, and now need a site that better represents their brand and supports more advanced marketing efforts.",
        borderClass: "border-l border-b",
    },
    {
        title: "Typical results",
        description:
            "More polished design, improved performance, and a website that is easier to expand with new pages, forms, and integrations.",
        borderClass: "border-r border-t",
    },
    {
        title: "Where we rebuild",
        description:
            "Typically Webflow or Framer for marketing sites and landing pages, and WordPress when a content-heavy structure or blog-focused setup is more suitable.",
        borderClass: "border-l border-t",
    },
];

const features = [
    "Comprehensive audit and stabilization of existing Elementor sites",
    "Targeted improvements to performance, user experience, and site structure",
    "Clear, practical guidance on whether to stay with Elementor or move to Webflow or Framer",
];
                ...
                <div className="flex flex-col lg:flex-row gap-10 lg:gap-16">
                    ...
                    <div className="flex flex-col gap-6 lg:w-[45%] shrink-0">
                        ...
                        <div className="flex items-center gap-4">
                            <img
                                src={elementorGlance}
                                alt="A glance at Elementor"
                                className="w-14 h-14 rounded-lg object-cover"
                            />
                            <h2 className="text-2xl sm:text-3xl font-semibold text-foreground">
                            A glance at Elementor
                            </h2>
                        </div>
                        ...
                        <div className="border-l-2 border-border pl-5">
                            ...
                            We typically work with Elementor when you already have an existing site built on it. Our priority is to improve performance, simplify management, and stabilize what’s there then guide you toward a stronger long-term platform when the timing is right.                            </p>
                        </div>
...
export default ElementorGlance;

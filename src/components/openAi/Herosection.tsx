...
import dashboardImg from "@/assets/Openai/openai-project-ss.png";
import { useRef, useEffect } from "react";
import openaiLogo from "@/assets/Openai/openai-logo.webp";
import openaiLogoWithOutBG from "@/assets/Openai/openai-without-bglogo.png"
const ICON_COUNT = 7;
const SPEED = 0.00005;
...
const HeroBadge = () => {
    return (
        <div className="badge-frosted inline-flex items-center gap-2 px-3 py-1.5">
            <img
                src={openaiLogoWithOutBG}
                alt="HubSpot"
                className="w-3 h-3 object-cover"
            />
            <span className="text-sm font-medium text-foreground">
                OpenAi & Ai product experts
            </span>
        </div>
    );
};
        ...
        <div className="min-h-screen bg-background overflow-hidden">
            ...
            <section className="relative w-full">
                ...
                <div className="relative z-10 flex flex-col items-center pt-32 sm:pt-40 px-4">
                    ...
                    >
                        OpenAI agency for AI interfaces and chatbots
                    </motion.h1>
                    ...
                    >
                        We design and build AI-powered experiences on top of OpenAI—from branded chatbots and support assistants to internal tools and lightweight AI products. You get solutions that feel aligned with your brand, are thoughtfully implemented for safe use, and integrate smoothly with the tools your team already depends on.
                    </motion.p>

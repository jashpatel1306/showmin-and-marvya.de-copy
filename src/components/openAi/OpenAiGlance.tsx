...
import openAiGlance from "@/assets/Openai/openai-logo.webp";
...
const cards = [
    {
      ...
      description:
        "Branded website chatbots, lead qualification assistants, help center AI guides, internal knowledge bots, and lightweight AI features embedded alongside your product.",
      borderClass: "border-r border-b",
    },
    {
      title: "Best for teams that",
      description:
        "Receive recurring customer or internal questions, want stronger self-serve support, or have clear opportunities where AI can streamline daily operations.",
      borderClass: "border-l border-b",
    },
    {
      title: "Typical results",
      description:
        "Quicker, more consistent answers for users, reduced repetitive workload for your team, and better insight into common questions and demand patterns.",
      borderClass: "border-r border-t",
    },
    {
      title: "How we apply OpenAI",
      description:
        "Across marketing websites, web applications, customer support workflows, and internal tools that help teams draft content, summarize information, or retrieve knowledge faster.",
      borderClass: "border-l border-t",
    },
  ];

const features = [
  "Branded chatbots and customer support assistants",
  "AI-powered interfaces embedded in your product or website",
  "Internal AI tools that streamline workflows and save your team time",
];
                ...
                <div className="flex flex-col lg:flex-row gap-10 lg:gap-16">
                    ...
                    <div className="flex flex-col gap-6 lg:w-[45%] shrink-0">
                        ...
                        <div className="border-l-2 border-border pl-5">
                            ...
                            We use OpenAI to power dependable, purpose-built assistants that answer questions, guide users, and support your team across your website, product experience, and internal workflows.
                            </p>
                        </div>

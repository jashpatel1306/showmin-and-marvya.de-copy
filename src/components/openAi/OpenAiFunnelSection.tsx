...
import centralIcon from "@/assets/Openai/openai-logo.webp";
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="text-center mb-10 md:mb-16 space-y-4 md:space-y-5">
                    <h2 className="section-title text-foreground">
                        Plug OpenAI into your product and workflows
                    </h2>
                    <p className="text-muted-foreground text-sm sm:text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
                    We integrate OpenAI with your website, product, and internal tools, so AI enhances your existing workflows instead of forcing you to adopt an entirely new system.
                    </p>
                </div>
...
export default OpenAiFunnelSection;

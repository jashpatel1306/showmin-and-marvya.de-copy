...
import heroImg from "@/assets/WebsiteDesign/WebsiteDesign.png";
...
const deliverables = [
    {
      title: "Discovery and content outline",
      desc: "A focused session and short questionnaire to understand your goals, audience, and offers, plus a clear content outline for key pages.",
    },
    {
      title: "Sitemap and page structure",
      desc: "A clear overview of the pages and templates to be designed, including how they connect and support important user journeys.",
    },
    {
      title: "Wireframes for core templates",
      desc: "Low-fidelity wireframes for main page types such as home, services, pricing, resources, and contact, focused on layout and hierarchy.",
    },
    {
      title: "High-fidelity page designs",
      desc: "Full visual page designs in Figma for the agreed templates and key variations, ready for review and development.",
    },
    {
      title: "Component and style guide",
      desc: "A simple design system with reusable components, color tokens, and typography rules to keep the site consistent.",
    },
    {
      title: "Developer-ready handoff",
      desc: "Clean, organized Figma files with notes for developers, including interaction states and implementation guidance.",
    },
  ];
  ...
  const processSteps = [
    {
      ...
      desc: "We review your current site, goals, and constraints, then gather brand assets, inspiration, and any internal requirements.",
    },
    {
      n: "2",
      title: "Structure and wireframing",
      desc: "We define the sitemap and key templates, then create wireframes that outline content hierarchy, layout, and calls to action.",
    },
    {
      n: "3",
      title: "Visual design and refinement",
      desc: "Wireframes are translated into full visual designs, applying your brand, building components, and refining details through feedback.",
    },
    {
      n: "4",
      title: "Handoff and support",
      desc: "We deliver organized design files, walk through them with your team or developers, and remain available for support during development.",
    },
  ];
...
const overviewSections = [
    {
        title: "Design That Makes Your Offer Easy to Understand",
        body: `Good website design starts with simple questions: what do you do, who is it for, and why does it matter. Many sites skip these basics and jump straight into visual effects. The result might look impressive but leaves visitors confused.
  
  We keep clarity at the center of the design process. Pages are structured so visitors quickly understand your offer, see they are in the right place, and know what to do next. Before designing layouts, we review your positioning, audience, and offers so every page has a clear role.`,
        bullets: [],
        subSections: [],
    },

    {
        title: "Starting With Content, Goals, and Structure",
        body: `Most projects begin with a short discovery phase and a set of low fidelity wireframes. This allows us to agree on structure, hierarchy, and messaging before moving into visual design.
  
  Once the structure feels right, we move into high fidelity design. Brand elements, typography, spacing, and visual rules are refined to create a consistent and practical interface.`,
        bullets: [
            "Homepage structure and messaging",
            "Service or product page layouts",
            "Pricing and conversion sections",
            "Resource or blog templates",
...

    {
        ...
        body: `Websites that grow well rely on reusable patterns. Instead of designing each page from scratch, we create shared components and layout systems that can be reused across the site.
  
  This makes future updates easier and keeps the experience consistent as the site grows.`,
        bullets: [
            "Hero section patterns",
            "Service or product content blocks",
            "Testimonials and proof sections",
            "Pricing layouts",
            "FAQ and contact modules"
        ],
        subSections: [],
    },

    {
        title: "Brand Aligned Without Feeling Overdesigned",
        body: `A strong website can feel visually refined while still remaining calm and readable. We use color, typography, and spacing to create a tone that fits your brand without overwhelming the content.
  
  Motion, visuals, and illustrations are introduced only when they improve clarity or add personality to the experience.`,
        bullets: [],
        subSections: [],
    },

    {
        title: "Ready for Webflow, Framer, or WordPress",
        body: `Design should be practical to build. Throughout the project we consider how layouts will translate into Webflow, Framer, or WordPress. This influences grid systems, breakpoints, reusable sections, and CMS structure.
  
  Figma files are delivered clean and organized so developers can build efficiently and maintain design quality.`,
        bullets: [
            "Clean and structured Figma files",
            "Reusable components and layouts",
            "Clear layer naming and organization",
            "Design states for key interactions"
        ],
        subSections: [],
    },

    {
        title: "Designed for Teams Who Care About Results",
        body: `This service is for teams who want their website to support real marketing and sales outcomes, not just look good.
  
  Whether you are launching a new website, replacing an outdated one, or preparing for a larger development project, the result is a design that balances clarity, brand consistency, and practical implementation.`,
        bullets: [],
        subSections: [],
    },
];
    ...
    return (
        <div className="space-y-8">
            ...
            <p className="text-[15px] leading-relaxed text-foreground">
                We design websites that combine clarity, usability, and build-ready design. The result is a thoughtful structure, refined visuals, and layouts that support meaningful business results.
            </p>
            {/* Category + Tools */}
    ...
    <div className="rounded-2xl border border-border bg-card p-6 space-y-5 shadow-sm">
        <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
                Design and build of a custom AI interface.
            </p>
        </div>
        ...
        <div className="space-y-3 pt-1">
            {[
                "Use case definition and content mapping",
                "Conversation flow and interface design",
                "AI configuration, guardrails, testing, launch support, and basic analytics",
            ].map((text) => (

...
import heroImg from "@/assets/TechnicalSeoAudit/technical-seo-audit.png";
...
const deliverables = [
    {
      title: "Technical crawl and indexing report",
      desc: "A clear overview of how key pages are crawled and indexed, including sitemaps, robots directives, status codes, canonical tags, and duplicate signals.",
    },
    {
      title: "Site structure and internal linking insights",
      desc: "Analysis of your information architecture, navigation, and internal linking with practical recommendations to improve SEO and usability.",
    },
    {
      title: "Platform-specific technical checks",
      desc: "Review of Webflow, Framer, or WordPress configurations that can impact SEO, including templates, scripts, plugins, and system settings.",
    },
    {
      title: "Performance and Core Web Vitals overview",
      desc: "A snapshot of load speed, layout stability, and responsiveness across key templates, with notes on technical factors affecting performance.",
    },
    {
      title: "Prioritized issues and recommendations",
      desc: "A structured list of issues ranked by impact and effort, with clear explanations and actionable steps for your team.",
    },
    {
      title: "Summary and improvement roadmap",
      desc: "A concise summary of findings with a practical roadmap to guide your technical SEO improvements over the coming months.",
    },
  ];
  ...
  const processSteps = [
    {
      ...
      desc: "We start with a short call to understand your site, goals, and platform, then collect the access and data needed to begin the audit.",
    },
    {
      n: "2",
      title: "Crawl and technical analysis",
      desc: "We crawl your site and review search, analytics, templates, and technical settings that influence crawling, indexing, and performance.",
    },
    {
      n: "3",
      title: "Insights and prioritization",
      desc: "Issues are grouped into key themes and prioritized by impact and effort, turning findings into clear and actionable recommendations.",
    },
    {
      n: "4",
      title: "Review and handover",
      desc: "We walk you through the results, answer questions, and deliver a clear roadmap so your team knows exactly what to fix and when.",
    },
  ];
...
const overviewLong = `For many teams, technical SEO stays in the background. Pages get added, plugins are installed, and design updates go live — but no one has a clear picture of how those changes affect crawling and indexing. Over time, small issues can build up into slow pages, unnecessary redirects, and mixed signals for search engines.

Our technical SEO audit gives you a clear view of what search engines are actually seeing. Instead of overwhelming you with jargon, we provide a structured, practical assessment of how your website behaves behind the scenes.
...
const overviewSections = [
    {
        title: "See How Search Engines Really View Your Site",
        body: "For many teams, technical SEO stays in the background. Pages get added, plugins are installed, and design updates go live — but no one has a clear picture of how those changes affect crawling and indexing. Over time, small issues can build up into slow pages, unnecessary redirects, and mixed signals for search engines. Our technical SEO audit gives you a clear view of what search engines are actually seeing. Instead of overwhelming you with jargon, we provide a structured, practical assessment of how your website behaves behind the scenes",
        bullets: [],
    },
    {
        title: "Crawl, Indexation, and Status Codes",
        body: `If search engines cannot properly crawl or index your pages, nothing else matters.
      
      We review how your site is discovered and stored in search engines, including sitemaps, robots directives, canonical tags, redirects, and status codes
      
      During this process, we identify issues such as:`,
        bullets: [
    ...
    {
        title: "Site Structure and Internal Linking",
        body: `Technical SEO is closely tied to your site’s structure. A clear hierarchy helps both users and search engines understand which pages matter most.
      
      We analyze how your key sections and templates are organized and how internal links connect them. This allows us to highlight where:`,
        bullets: [
            "Important pages are buried too deep",
            "Navigation is working against your SEO",
            "Keyboard-navigable menus and interactive components",
        ],
    },
    {
        title: "Platform-Specific Checks",
        body: "Different platforms come with different technical quirks. Because we regularly work with Webflow, Framer, and WordPress, we know where common SEO issues appear. Our audit includes platform-specific checks — we focus on identifying real issues that affect performance and search visibility, not theoretical perfection.",
        subSections: [
            {
                title: "Webflow",
                bullets: [
                    ...
                    "Script embeds and interactions",
                ],
            },
            {
                title: "Framer",
                bullets: [
                    "Page export behaviour",
                    "Routing structure",
                    "Script and media loading",
                ],
            },
            {
                title: "WordPress",
...

    {
        ...
        body: `Your audit also includes a performance review of key templates and pages.
        
        We analyze how quickly important content loads, how stable layouts are during loading, and how responsive pages feel to user input. These signals are then connected back to the technical decisions that influence them.
        
        Rather than turning the audit into a full performance project, we identify the technical changes that may be limiting your Core Web Vitals. If deeper optimization is required, we clearly outline the next steps.`,
        bullets: [],
    },

    {
        title: "Index Hygiene and Duplicate URLs",
        body: `Modern websites often generate far more URLs than expected. Filters, parameters, archives, and experiments can quietly create duplicate or near-duplicate pages.
        
        Left unmanaged, this can waste crawl budget and dilute SEO signals.
        
        We review how your website handles:`,
        bullets: [
            "Parameters and filtered URLs",
            "Pagination and archive pages",
            "Duplicate templates and content variations"
        ],
    },

    {
        title: "Turning Insights Into a Clear Action Plan",
        body: `A technical audit only matters if it leads to action.
        
        After the analysis, we deliver a prioritized list of improvements grouped by impact and effort. This helps your team quickly understand.`,
        bullets: [
            "What should be fixed immediately",
            "What can be planned for later",
            "What may not require action right now"
        ],
    },

    {
        title: "Built for Teams Who Want Clarity",
        body: `This service is designed for teams who want a clear, honest understanding of their technical SEO without unnecessary complexity.
        
        Instead of dramatic warnings or overwhelming reports, you receive a structured overview of your website’s technical health — along with a calm, practical roadmap for improvement.`,
        bullets: [],
    },
];
    ...
    return (
        <div className="space-y-8">
            ...
            <p className="text-[15px] leading-relaxed text-foreground">
                We evaluate the technical foundation of your website to ensure search engines can easily crawl, understand, and trust your content. You’ll receive a transparent report of what’s happening behind the scenes, plus a prioritized roadmap of improvements your team can implement.
            </p>
            {/* Category + Tools */}
...
const Aside = () => (
    <div className="rounded-2xl border border-border bg-card p-6 space-y-5 shadow-sm">
        ...
        <div className="space-y-3 pt-1">
            {[
                "Crawl and indexing analysis with status code checks",
                "Site architecture and internal linking optimization",
                "Platform-specific technical checks for Webflow, Framer, and WordPress",
            ].map((text) => (

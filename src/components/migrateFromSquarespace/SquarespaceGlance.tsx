...
import squarespaceGlance from "@/assets/Squarespace/squarespace-icon.png";
...
const cards = [
    {
      ...
      description:
        "Migrating service-based and studio websites from Squarespace, redesigning marketing sites, and moving landing pages, blogs, or lightweight stores into Webflow or Framer.",
      borderClass: "border-r border-b",
    },
    {
      title: "Best for teams that",
      description:
        "Started with Squarespace but now prioritize stronger branding, better performance, or improved SEO—and feel constrained by template limitations.",
      borderClass: "border-l border-b",
    },
    {
      title: "Typical results",
      description:
        "More refined design, improved speed, and a website that’s easier to expand with new pages, content hubs, and marketing campaigns.",
      borderClass: "border-r border-t",
    },
    {
      title: "Where we migrate Squarespace sites",
      description:
        "Typically Webflow or Framer for modern marketing sites and landing pages, and WordPress when a larger content-driven structure or blog-heavy setup is required.",
      borderClass: "border-l border-t",
    },
  ];

const features = [
    "Strategic redesign of core Squarespace pages and layout structures",
    "Full rebuild in Webflow or Framer using a modern, scalable framework",
    "Carefully managed redirects to preserve SEO value and existing links",
];
                ...
                <div className="flex flex-col lg:flex-row gap-10 lg:gap-16">
                    ...
                    <div className="flex flex-col gap-6 lg:w-[45%] shrink-0">
                        ...
                        <div className="flex items-center gap-4">
                            <img
                                src={squarespaceGlance}
                                alt="A glance at Squarespace"
                                className="w-14 h-14 rounded-lg object-cover"
                            />
                            <h2 className="text-2xl sm:text-3xl font-semibold text-foreground">
                            A glance at Squarespace
                            </h2>
                        </div>
                        ...
                        <div className="border-l-2 border-border pl-5">
                            ...
                            We partner with teams who chose Squarespace for its simplicity and speed, but now need greater control over design flexibility, content structure, and SEO. Our aim is to deliver a site that remains easy to edit—while giving you the scalability and structure needed to support long-term growth.
                            </p>
                        </div>
...
export default SquarespaceGlance;

...
const reasons: ReasonItem[] = [
    {
      title: "Proven experience migrating from Squarespace",
      description:
        "We understand how Squarespace sites are structured and how to transition them into Webflow, Framer, or WordPress while preserving the elements that already perform well.",
    },
    {
      title: "Integrated design and development",
      description:
        "We manage both the redesign and the rebuild, ensuring the final result feels cohesive and thoughtfully upgraded—not just a quick replica of your previous site.",
    },
    {
      title: "SEO-focused and stable transitions",
      description:
        "We carefully handle redirects, analytics, and launch processes to protect search visibility and maintain smooth user journeys throughout the migration.",
    },
  ];
    ...
    return (
        <section className="w-full bg-gradient-to-b from-secondary to-background py-16 md:py-24">
            <div className="mx-auto max-w-3xl px-4 md:px-6">
                ...
                Why work with Showmine on Squarespace migration
                </h2>

...
import centralIcon from "@/assets/Squarespace/squarespace-icon.png";
...
const SquarespaceFunnelSection = () => {
    return (
        <section className="max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-16">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="text-center mb-10 md:mb-16 space-y-4 md:space-y-5">
                    ...
                    Move from Squarespace to a platform that can grow with you
                    </h2>
                    <p className="text-muted-foreground text-sm sm:text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
                    We help you transition from Squarespace to Webflow, Framer, or WordPress prioritizing elevated design, improved performance, and careful preservation of the traffic, rankings, and content you’ve already built.                    </p>
                </div>
...
export default SquarespaceFunnelSection;

...
import squarespaceLogoDashboardImg from "@/assets/Squarespace/squarespace-project-ss.png";
import { useEffect, useRef } from "react";
import squarespaceLogo from "@/assets/Squarespace/squarespace-icon.png";
    ...
    return (
        <div className="badge-frosted inline-flex items-center gap-2 px-3 py-1.5">
            ...
            <span className="text-sm font-medium text-foreground">
                Squarespace to Webflow, Shopify & Framer
            </span>
        </div>
    );
};
        ...
        <div className="min-h-screen bg-background overflow-hidden">
            ...
            <section className="relative w-full">
                ...
                <div className="relative z-10 flex flex-col items-center pt-32 sm:pt-40 px-4">
                    ...
                    >
                        Migrate from Squarespace when you have outgrown it
                    </motion.h1>
                    ...
                    >
                        If your Squarespace site has served you well but now feels restrictive, we can help you transition to a faster, more flexible platform like Webflow or Framer. We start by mapping your existing structure, redesigning the pages that matter most, and rebuilding everything in a modern, scalable stack. We also manage the migration carefully setting up redirects and preserving SEO, so both visitors and search engines clearly understand where your content has moved.
                    </motion.p>
                ...
                >
                    ...
                    >
                        <img
                            src={squarespaceLogoDashboardImg}

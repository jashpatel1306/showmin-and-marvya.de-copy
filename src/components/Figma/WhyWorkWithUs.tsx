...
const reasons: ReasonItem[] = [
    {
      ...
      description:
        "We create designs that translate cleanly into Webflow, Framer, or front-end code, ensuring smoother handoffs and fewer surprises during development.",
    },
    {
      title: "Well-structured, maintainable files",
      description:
        "Our Figma files stay organized with clear layer naming, consistent styles, and structured components so your team can confidently work with them.",
    },
    {
      title: "Support beyond the handoff",
      description:
        "We can continue helping you expand the system, design new screens, and maintain a consistent design language as your product and marketing grow.",
    },
  ];
    ...
    return (
        <section className="w-full bg-gradient-to-b from-secondary to-background py-16 md:py-24">
            <div className="mx-auto max-w-3xl px-4 md:px-6">
                ...
                Why work with a Figma-focused team like Showmine
                </h2>

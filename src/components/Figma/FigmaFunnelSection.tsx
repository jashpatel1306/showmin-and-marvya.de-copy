...
import centralIcon from "@/assets/Figma/logo.svg";
        ...
        <section className="max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-16">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="text-center mb-10 md:mb-16 space-y-4 md:space-y-5">
                    ...
                    Make Figma the design hub for your company
                    </h2>
                    <p className="text-muted-foreground text-sm sm:text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
                    We plug Figma into how your team already works – from reviews to dev handoff – so it becomes the natural home for your product and marketing UI.
                    </p>
                </div>
...
export default FigmaFunnelSection;

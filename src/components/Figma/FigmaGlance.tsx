...
import figmaGlance from "@/assets/Figma/logo.svg";
...
const cards = [
    {
      ...
      description:
        "Complete website UI, landing page collections, product marketing pages, dashboards and application screens, along with shared component libraries.",
      borderClass: "border-r border-b",
    },
    {
      title: "Best for teams that",
      description:
        "Need a single source of truth for UI, want smoother handoffs to development, and value consistent interfaces across pages and products.",
      borderClass: "border-l border-b",
    },
    {
      title: "Typical results",
      description:
        "Organized design files, faster iteration cycles, fewer design–development gaps, and a UI system that scales as your product grows.",
      borderClass: "border-r border-t",
    },
    {
      title: "Figma workflows we rely on",
      description:
        "Structured component libraries, Auto Layout, design styles, and interactive prototypes so teams can design, review, and build from the same system.",
      borderClass: "border-l border-t",
    },
  ];

const features = [
    "Clean, organized Figma files",
    "Reusable components and variants",
    "Prototypes stakeholders can click through",
];
                    ...
                    <div className="flex flex-col gap-6 lg:w-[45%] shrink-0">
                        ...
                        <div className="border-l-2 border-border pl-5">
                            <p className="text-muted-foreground leading-relaxed">
                                We use Figma as the central workspace for UI, UX, components, and collaboration—keeping design, product, and development aligned so your team can design, review, and ship faster
                            </p>
                        </div>

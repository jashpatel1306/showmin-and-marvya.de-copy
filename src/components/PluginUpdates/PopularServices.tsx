...
const popularServices = [
  {
    ...
    description: "Troubleshooting and repair service for WordPress sites",
    href: "/",
  ...
  },
  {
    ...
    description: "A managed backup setup and routine",
    href: "/",
    accent: "green" as const,
  },
  {
    title: "Security patching",
    description: "Ongoing security patching for your website",
    href: "/",

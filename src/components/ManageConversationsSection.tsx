...
export function ManageConversationsSection() {
  ...
  useEffect(() => {
    const tabs = ["manage", "reach", "automate", "analyse", "govern"];

    const handleScroll = () => {
      // 1. Check sticky bar visibility bounds:
      // Starts when five-tab-nav-anchor reaches top header (rect.top <= 60)
      // Ends when section-govern bottom passes under sticky bar (governRect.bottom <= 108)
      const anchorEl = document.getElementById("five-tab-nav-anchor");
      const governEl = document.getElementById("section-govern");

      if (anchorEl && governEl) {
        const anchorTop = anchorEl.getBoundingClientRect().top;
        const governBottom = governEl.getBoundingClientRect().bottom;

        if (anchorTop <= 60 && governBottom > 108) {
          setIsSticky(true);
        } else {
          setIsSticky(false);
        }
  ...
  const features = [
    {
      id: "ai-agents",
      title: "AI Agents trained on your data",
  ...
  const renderNavButtons = () => (
    <div className="w-full bg-white grid grid-cols-5 border-t border-b border-[#D1D1D6] divide-x divide-[#D1D1D6]">
      {["MANAGE", "REACH", "AUTOMATE", "ANALYSE", "GOVERN"].map((tab) => {
        const isActive = activeTab === tab;
        return (
          <button
            key={tab}
            onClick={() => scrollToSection(tab)}
            className={`py-3 sm:py-3.5 px-0.5 sm:px-2 text-[9.5px] min-[380px]:text-[11px] md:text-[12px] font-mono font-bold tracking-normal min-[380px]:tracking-wider sm:tracking-widest transition-all relative cursor-pointer text-center truncate ${
              isActive
  ...
  return (
    <section className="bg-white relative">
      ...
      <div className="relative mx-auto max-w-[1358px] w-full flex justify-center">
        ...
        {/* 1. MANAGE SECTION */}
        <div id="section-manage" className="w-full flex flex-col items-center pt-4">
          {/* Section Header */}
          <div className="pt-8 md:pt-12 pb-8 md:pb-10 px-4 md:px-6 text-center max-w-[860px] mx-auto flex flex-col items-center">
            ...
            <h2 className="font-serif text-[#131316] text-[28px] sm:text-[36px] md:text-[40px] lg:text-[42px] leading-[1.2] tracking-tight font-semibold mb-3 md:mb-4">
              Centralized inbox to manage WhatsApp chats, calls and groups across all your numbers
            </h2>
            <p className="text-neutral-500 text-xs sm:text-sm md:text-[15px] leading-relaxed max-w-[660px]">
              Track all conversations across various numbers in one centralised location, simplifying communication management and ensuring nothing gets missed.
            </p>
          </div>
      ...
      <div className="w-full px-4 md:px-8 pb-0 pt-0">
                ...
                {features.map((feat, idx) => {
                  ...
                  return (
                    <button
                      ...
                      className={`p-4 rounded-xl text-left transition-all flex gap-3.5 items-start border cursor-pointer ${
                        isActive
        ...
        {/* 2. REACH SECTION */}
        <div id="section-reach" className="w-full flex flex-col items-center pt-0 pb-0">
          <div className="pt-4 pb-8 px-4 md:px-6 text-center max-w-[860px] mx-auto flex flex-col items-center">
            ...
            <h2 className="font-serif text-[#131316] text-[28px] sm:text-[36px] md:text-[40px] lg:text-[42px] leading-[1.2] tracking-tight font-semibold mb-3 md:mb-4">
              Broadcast bulk WhatsApp messages with high deliverability & instant tracking
            </h2>
            <p className="text-neutral-500 text-xs sm:text-sm md:text-[15px] leading-relaxed max-w-[660px]">
              Send targeted campaigns to unlimited opted-in contacts, schedule bulk announcements with custom attributes, and measure real-time ROI.
            </p>
          </div>
        ...
        <div id="section-automate" className="w-full flex flex-col items-center pt-0 pb-0">
          <div className="pt-4 pb-8 px-4 md:px-6 text-center max-w-[860px] mx-auto flex flex-col items-center">
            ...
            <h2 className="font-serif text-[#131316] text-[28px] sm:text-[36px] md:text-[40px] lg:text-[42px] leading-[1.2] tracking-tight font-semibold mb-3 md:mb-4">
              AI Agents and automated bots trained specifically on your business data
            </h2>
            <p className="text-neutral-500 text-xs sm:text-sm md:text-[15px] leading-relaxed max-w-[660px]">
              Deliver instant 24/7 resolution, qualify incoming leads automatically, and integrate seamlessly with your CRM and e-commerce tech stack.
            </p>
          </div>
        ...
        {/* 4. ANALYSE SECTION */}
        <div id="section-analyse" className="w-full flex flex-col items-center pt-0 pb-0">
          <div className="pt-4 pb-8 px-4 md:px-6 text-center max-w-[860px] mx-auto flex flex-col items-center">
            <div className="flex items-center gap-2 justify-center mb-3">
              <span className="w-4 h-px bg-emerald-600/60" />
              <span className="text-[11px] font-bold font-mono text-emerald-600 tracking-[0.2em] uppercase">
            ...
            <h2 className="font-serif text-[#131316] text-[28px] sm:text-[36px] md:text-[40px] lg:text-[42px] leading-[1.2] tracking-tight font-semibold mb-3 md:mb-4">
              Real-time dashboard analytics for chat volume, team SLAs, and performance
            </h2>
            <p className="text-neutral-500 text-xs sm:text-sm md:text-[15px] leading-relaxed max-w-[660px]">
              Monitor team response speeds, SLA breaches, peak messaging hours, and conversion rates across all your numbers in real-time.
            </p>
          </div>
        ...
        {/* 5. GOVERN SECTION */}
        <div id="section-govern" className="w-full flex flex-col items-center pt-0 pb-20">
          <div className="pt-4 pb-8 px-4 md:px-6 text-center max-w-[860px] mx-auto flex flex-col items-center">
            <div className="flex items-center gap-2 justify-center mb-3">
              <span className="w-4 h-px bg-emerald-600/60" />
              <span className="text-[11px] font-bold font-mono text-emerald-600 tracking-[0.2em] uppercase">
            ...
            <h2 className="font-serif text-[#131316] text-[28px] sm:text-[36px] md:text-[40px] lg:text-[42px] leading-[1.2] tracking-tight font-semibold mb-3 md:mb-4">
              Granular access controls, masked customer numbers, and audit trails
            </h2>
            <p className="text-neutral-500 text-xs sm:text-sm md:text-[15px] leading-relaxed max-w-[660px]">
              Keep business contact databases secure with masked phone numbers, role-based permissions, and comprehensive activity logs.
            </p>
          </div>

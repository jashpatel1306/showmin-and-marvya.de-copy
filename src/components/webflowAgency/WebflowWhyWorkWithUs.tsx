...
const reasons: ReasonItem[] = [
    {
        title: "Webflow & SEO, perfectly aligned",
        description:
            "We don't just design beautiful Webflow sites, we build them to rank, convert, and grow your pipeline from day one.",
    },
    {
        title: "A calm, clear process",
        description:
            "No chaos. No confusing tools. Just a simple plan, regular check-ins, and steady progress you can trust.",
    },
    {
        title: "Ongoing support that grows with you",
        description:
            "After launch, we help you test, improve, and scale, so your site keeps performing instead of collecting dust."
    },
];

const WebflowWhyWorkWithUs = () => {
    return (
        <section className="w-full bg-gradient-to-b from-secondary to-background py-16 md:py-24">
            <div className="mx-auto max-w-3xl px-4 md:px-6">
                <h2 className="section-title text-foreground text-center mb-12">
                    Why work with a Webflow agency like us
                </h2>
                <p className="text-muted-foreground text-center mb-8">
                    3 good reasons to partner with a Showmine team that cares about your results as much as you do.
                </p>
...
export default WebflowWhyWorkWithUs;

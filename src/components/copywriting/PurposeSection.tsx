...
import purposeShowcase from "@/assets/Copywriting/project.webp";

const features = [
    {
      title: "Begin with discovery",
      description:
        "Focused interviews and a concise questionnaire to understand your offers, audience, and objectives.",
    },
    {
      title: "Structure clear messaging",
      description:
        "Well-defined page frameworks that guide visitors from a quick overview to deeper detail in a natural flow.",
    },
    {
      title: "Refine every detail",
      description:
        "Headlines, body copy, and microcopy crafted to feel consistent, confident, and aligned with your brand voice.",
    },
  ];
...
const PurposeSection = () => (
  <section className="mx-auto max-w-[1240px] px-4 py-7 md:py-12">
    ...
    <div className="mb-10 flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
      ...
      >
        We get to know how you speak, what your customers care about, and what worries them. Then we write copy that sounds natural for you and helpful for them.
      </motion.p>
    </div>

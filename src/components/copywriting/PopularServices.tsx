...
const popularServices = [
  ...
  {
    title: "Ghostwriting",
    description: "Ongoing ghostwriting support for founders and teams",
  ...
  },
  {
    ...
    description: "SEO blog articles that grow your website",
    href: "/services/custom-ai-interface",
    accent: "purple" as const,
  },
  {
    title: "Landing-page copywriting",
    description: "Present a clear offer and guide visitors to the next step ",

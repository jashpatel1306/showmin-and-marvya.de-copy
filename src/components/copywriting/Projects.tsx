...
import projectVoiceflow from "@/assets/Copywriting/project1.webp";
...
import bgBlueOrange from "@/assets/Copywriting/project-bg-ss-01.jpg";
...
const projects = [
  {
    ...
    statValue: "300%",
    statLabel: "Ongoing design and development support for Voiceflow's marketing site.",
    category: "SaaS",
    countryFlag: "🇨🇦",
    description:
      "Ongoing design and development support for Voiceflow's marketing site.",
    testimonial:
      "Having recently worked with South Digital for some bespoke web design and build, I can honestly say that these guys exceeded all expectations. Easy communication and a great eye for detail. Very happy.",
    reviewerName: "Steve Humphrey",

...
import ga4Glance from "@/assets/Ga4/ga4-logo.svg";
...
const cards = [
    {
      ...
      description:
        "GA4 migrations, tracking audits and cleanups, custom event frameworks for websites and funnels, enhanced measurement setups, and ecommerce or lead conversion tracking.",
      borderClass: "border-r border-b",
    },
    {
      title: "Best for teams that",
      description:
        "Depend on their website and funnels for revenue, question the accuracy of their current data, and need reporting that informs marketing and executive decisions.",
      borderClass: "border-l border-b",
    },
    {
      title: "Typical results",
      description:
        "Reliable data, clear insight into channel performance, and visibility into where users drop off across key journeys.",
      borderClass: "border-r border-t",
    },
    {
      title: "Tools we use",
      description:
        "Google Analytics 4, Google Tag Manager, Google Search Console, Looker Studio, along with your website platform and CRM to ensure everything connects properly.",
      borderClass: "border-l border-t",
    },
  ];

const features = [
  "GA4 setup, audits, and account cleanups",
  "Clear, meaningful event and conversion tracking aligned with your goals",
  "Practical dashboards your team can understand and use confidently",
];
                ...
                <div className="flex flex-col lg:flex-row gap-10 lg:gap-16">
                    ...
                    <div className="flex flex-col gap-6 lg:w-[45%] shrink-0">
                        ...
                        <div className="flex items-center gap-4">
                            <img
                                src={ga4Glance}
                                alt="A glance at Google Analytics"
                                className="w-14 h-14 rounded-lg object-cover"
                            />
                            <h2 className="text-2xl sm:text-3xl font-semibold text-foreground">
                            A glance at Google Analytics
                            </h2>
                        </div>
                        ...
                        <div className="border-l-2 border-border pl-5">
                            ...
                            We use Google Analytics 4 to give you a clear, structured view of how people discover your business, how they interact with your site, and exactly where they drop off within your funnels.                            </p>
                        </div>

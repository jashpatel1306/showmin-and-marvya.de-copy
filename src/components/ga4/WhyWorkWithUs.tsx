...
const reasons: ReasonItem[] = [
    {
      title: "Web, funnels, and tracking aligned",
      description:
        "We design and build websites and funnels alongside analytics setups, so we understand exactly what should be measured and how to connect everything correctly.",
    },
    {
      title: "Focused, decision-ready reporting",
      description:
        "We prioritize clarity over clutter. Instead of overwhelming dashboards or vanity metrics, you get concise views that guide decisions on channels, pages, and campaigns.",
    },
    {
      title: "Ongoing tracking support",
      description:
        "As your website, funnels, or tools evolve, we update and refine your tracking setup to keep GA4 accurate and aligned with your business.",
    },
  ];
    ...
    return (
        <section className="w-full bg-gradient-to-b from-secondary to-background py-16 md:py-24">
            <div className="mx-auto max-w-3xl px-4 md:px-6">
                ...
                Why work with a Google Analytics agency like Showmine

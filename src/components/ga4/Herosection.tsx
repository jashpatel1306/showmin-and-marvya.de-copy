...
import dashboardImg from "@/assets/Ga4/ga4-project-ss.png";
import { useRef, useEffect } from "react";
import ga4Logo from "@/assets/Ga4/ga4-logo.svg";
        ...
        <div className="min-h-screen bg-background overflow-hidden">
            ...
            <section className="relative w-full">
                ...
                <div className="relative z-10 flex flex-col items-center pt-32 sm:pt-40 px-4">
                    ...
                    >
                        Google Analytics agency for clear tracking
                    ...
                    >
                        We audit, repair, and properly configure Google Analytics 4 so your website, funnels, and campaigns are tracked accurately. The result is clean, meaningful events and reports aligned with how your business actually operates—not just a dashboard full of noise.
                    </motion.p>

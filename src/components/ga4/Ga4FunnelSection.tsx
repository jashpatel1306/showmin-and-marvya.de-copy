...
import centralIcon from "@/assets/Ga4/ga4-logo.svg";
        ...
        <section className="max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-16">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="text-center mb-10 md:mb-16 space-y-4 md:space-y-5">
                    ...
                    Make Google Analytics your source of truth
                    </h2>
                    <p className="text-muted-foreground text-sm sm:text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
                    We integrate GA4 with your website platform, funnels, CRM, and ad accounts, so you have a unified view of performance and a clear understanding of what’s driving results and where to focus next.
                    </p>
                </div>
...
export default Ga4FunnelSection;

...
const reasons: ReasonItem[] = [
    {
      title: "Websites, funnels, and automation aligned",
      description:
        "Because we design and build your websites and funnels as well, we understand what should happen at each stage and how to connect everything seamlessly within Make.",
    },
    {
      title: "Reliable and maintainable scenarios",
      description:
        "We prioritize clean, structured builds over fragile complexity. Your Make scenarios are documented, monitored, and designed to run reliably long term.",
    },
    {
      title: "Ongoing support and evolution",
      description:
        "As your tools and processes evolve, we help extend or refine automations and monitor performance so your workflows stay efficient.",
    },
  ];
    ...
    return (
        <section className="w-full bg-gradient-to-b from-secondary to-background py-16 md:py-24">
            <div className="mx-auto max-w-3xl px-4 md:px-6">
                ...
                Why work with a Make agency like Showmine
                </h2>

...
import projectBgOrangeBlue from "@/assets/Make/project-bg-ss-01.jpg";
...
const MakeRecentProjects = () => {
  return (
    <section className="max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-16 bg-background">
      ...
      Recent Make automation projects
      </h2>
      <div className="space-y-8 mb-14">
          <ProjectCard
            ...
            category="E-commerce"
            flag="🇬🇧"
            description="Website design, development and ongoing support for Clientflow."
            testimonial="Built a website beyond anything I ever imagined. Premium site and premium service!"
...
export default MakeRecentProjects;

...
import centralIcon from "@/assets/Make/make-logo.webp";
        ...
        <section className="max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-16">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="text-center mb-10 md:mb-16 space-y-4 md:space-y-5">
                    ...
                    We use Make to connect your website, CRM, forms, and internal tools—so information moves seamlessly between systems and your team can focus on higher-value, strategic work instead of manual admin.
                    </p>
                </div>
...
export default MakeFunnelSection;

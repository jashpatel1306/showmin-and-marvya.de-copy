...
import dashboardImg from "@/assets/Make/make-project-ss.png";
import { useRef, useEffect } from "react";
import makeLogo from "@/assets/Make/make-logo.webp";
import makeLogoWithOutBG from "@/assets/Make/make-without-bg-logo.png"
const ICON_COUNT = 7;
const SPEED = 0.00005;
...
const HeroBadge = () => {
    return (
        <div className="badge-frosted inline-flex items-center gap-2 px-3 py-1.5">
            <img
                src={makeLogoWithOutBG}
                alt="HubSpot"
                className="w-3 h-3 object-cover"
            />
            <span className="text-sm font-medium text-foreground">
                Make automation experts
            </span>
        </div>
    );
};
        ...
        <div className="min-h-screen bg-background overflow-hidden">
            ...
            <section className="relative w-full">
                ...
                <div className="relative z-10 flex flex-col items-center pt-32 sm:pt-40 px-4">
                    ...
                    >
                        Make agency for marketing and ops teams
                    </motion.h1>
                    ...
                    >
                        We design and build Make scenarios that automate repetitive tasks across your marketing and operations. The result is smoother handoffs, quicker follow-ups, and fewer opportunities slipping through the cracks.
                    </motion.p>

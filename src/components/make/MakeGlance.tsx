...
import makeGlance from "@/assets/Make/make-logo.webp";
...
const cards = [
    {
        ...
        description:
            "Automated lead routing from forms into your CRM, internal team notifications, pipeline stage updates, follow-up sequences, and reliable data syncing across tools.",
        borderClass: "border-r border-b",
    },
    {
        title: "Best for teams that",
        description:
            "Manage high volumes of leads or operational tasks, use multiple platforms, and want smarter automation without expanding their development team.",
        borderClass: "border-l border-b",
    },
    {
        title: "Typical results",
        description:
            "Quicker response times, reduced manual admin work, and clear visibility into where every lead, customer, or task sits in your workflow.",
        borderClass: "border-r border-t",
    },
    {
        title: "Platforms we connect through Make",
        description:
            "Webflow, Framer, WordPress, GoHighLevel, HubSpot, Pipedrive, Slack, email tools, Google Sheets, CRMs, and more—coordinated through structured Make scenarios.",
        borderClass: "border-l border-t",
    },
];

const features = [
    "Automation workflows designed around your real-world processes",
    "Clean, well-structured, and monitored Make scenarios",
    "Built to integrate seamlessly with the tools you already rely on",
];
                    ...
                    <div className="flex flex-col gap-6 lg:w-[45%] shrink-0">
                        ...
                        <div className="border-l-2 border-border pl-5">
                            <p className="text-muted-foreground leading-relaxed">
                                We use Make as the automation layer that connects your website, CRM, forms, and internal tools—so information moves seamlessly between systems without constant manual updates or repetitive admin work.
                            </p>
                        </div>

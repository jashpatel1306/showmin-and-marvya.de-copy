...
import purposeShowcase from "@/assets/Maintenance/4CLj5HZC3qMmnx3fblGIGwufbA.avif";

const features = [
    {
      title: "Easy change requests",
      description:
        "Send updates via email, Slack, ticket, or a quick Loom. We confirm the scope and provide a clear time or cost estimate.",
    },
    {
      title: "Defined priorities",
      description:
        "We help you decide what needs immediate attention, what can wait, and what may require a separate, larger project.",
    },
    {
      title: "Transparent progress",
      description:
        "Regular, concise updates outlining what’s completed, what’s next, and any recommendations for improvement.",
    },
  ];
const PurposeSection = () => (
    <section className="mx-auto max-w-[1240px] px-4 py-7 md:py-12">
        ...
        <div className="mb-10 flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
            ...
            >
                We combine regular checks with simple ways to request changes so you feel in control of your website.
            </motion.p>
        </div>
        ...
        <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
            className="rounded-xl bg-orange-600 p-3 pb-0"
        >
        ...
        >
            ...
            Need help with your website? We would love to chat.
            </h2>
            <a
                href="#get-started"

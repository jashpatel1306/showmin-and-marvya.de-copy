...
const features = [
  "Strategic redesign of core marketing and landing pages in Webflow",
  "Retain Shopify for product management and checkout functionality",
  "Seamless, connected user journeys between your marketing site and store",
];
          ...
          <div className="flex flex-col gap-6 lg:w-[45%] shrink-0">
            ...
            <div className="border-l-2 border-border pl-5">
              <p className="text-muted-foreground leading-relaxed">
                We partner with teams who need more flexibility and polish than their Shopify theme can provide—but still want to keep Shopify powering their commerce. Our approach combines a Webflow-driven marketing front end with your existing Shopify store, creating a seamless customer experience while keeping operations straightforward for your team.
              </p>
            </div>

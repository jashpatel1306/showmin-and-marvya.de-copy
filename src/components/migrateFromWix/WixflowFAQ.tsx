...
const wixFaqs = [
    {
      question: "Can you move our Wix site to Webflow or Framer?",
      answer:
        "Yes. Most Wix migrations we handle involve transitioning to Webflow or Framer. We carefully map your existing content, redesign priority pages, and rebuild them in the new platform with improved structure and performance.",
    },
    {
      question: "Will migrating away from Wix affect our SEO?",
      answer:
        "When managed correctly, it should not. We implement proper redirects from old URLs to new ones, update internal links, and preserve important content and metadata to maintain search visibility.",
    },
    {
      question: "Can you migrate our blog and resource content from Wix?",
      answer:
        "In most cases, yes. We export or recreate key posts and resources, then implement a stronger content structure in Webflow, Framer, or WordPress where appropriate.",
    },
    {
      question: "How long does a typical Wix migration take?",
      answer:
    ...
    {
      question: "What is the typical investment for a Wix migration?",
      answer:

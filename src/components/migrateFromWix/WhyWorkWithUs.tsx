...
const reasons: ReasonItem[] = [
    {
      title: "Experience with Wix and modern platforms",
      description:
        "We understand how Wix sites are structured and how to transition them into Webflow, Framer, or WordPress while preserving the elements that already perform well.",
    },
    {
      title: "Unified design and development team",
      description:
        "We manage both the redesign and the rebuild, ensuring the final result is visually cohesive and technically robust.",
    },
    {
      title: "SEO-focused and stable migrations",
      description:
        "We carefully handle redirects, analytics, and launch processes to safeguard search visibility and maintain smooth user journeys during the transition.",
    },
  ];
    ...
    return (
        <section className="w-full bg-gradient-to-b from-secondary to-background py-16 md:py-24">
            <div className="mx-auto max-w-3xl px-4 md:px-6">
                ...
                Why work with Showmine on Wix migration
                </h2>

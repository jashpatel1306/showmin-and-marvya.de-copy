    ...
    <section className="max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-16 bg-background">
      ...
      <div className="space-y-8 mb-14">
          <ProjectCard
            ...
            category="E-commerce"
            flag="🇬🇧"
            description="Redesigned a basic Wix site into a WordPress marketing asset."
            testimonial="Showmine is a fantastic way to drive your business forward. New opportunities come up all the time in ways you wouldn't even think of."
            avatarImage={avatarStuart}
            clientName="Rob King"
            clientRole="Owner at King Property"
          />
      </div>

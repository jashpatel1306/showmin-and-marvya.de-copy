...
import wixGlance from "@/assets/Wix/wix-icon.png";
...
const cards = [
    {
      ...
      description:
        "Migrating small business and service-based websites from Wix, redesigning marketing sites, and transitioning landing pages, blogs, and resource hubs into Webflow or Framer.",
      borderClass: "border-r border-b",
    },
    {
      title: "Best for teams that",
      description:
        "Chose Wix for speed and affordability, and now need stronger control over design flexibility, SEO foundations, and performance as the business scales.",
      borderClass: "border-l border-b",
    },
    {
      title: "Typical results",
      description:
        "More structured page architecture, improved loading speed, and a website that’s easier to expand with new pages, content sections, and integrations.",
      borderClass: "border-r border-t",
    },
    {
      title: "Where we migrate Wix sites",
      description:
        "Commonly to Webflow or Framer for modern marketing sites and landing pages, and to WordPress when a content-heavy structure or advanced blog setup is required.",
      borderClass: "border-l border-t",
    },
  ];

const features = [
    "Strategic redesign of core Wix pages and layout structures",
    "Full rebuild in Webflow or Framer using a modern, scalable framework",
    "Carefully managed redirects to preserve SEO equity and existing links",
];
                ...
                <div className="flex flex-col lg:flex-row gap-10 lg:gap-16">
                    ...
                    <div className="flex flex-col gap-6 lg:w-[45%] shrink-0">
                        ...
                        <div className="border-l-2 border-border pl-5">
                            ...
                            We partner with teams who began on Wix and now need greater flexibility, stronger performance, and more robust SEO foundations. Our goal is to deliver a site that retains a familiar structure—while making it far easier to scale, optimize, and evolve as your business grows.
                            </p>
                        </div>

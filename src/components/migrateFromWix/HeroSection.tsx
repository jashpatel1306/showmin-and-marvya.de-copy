...
import wixDashboardImg from "@/assets/Wix/wix-project-ss.png";
import { useEffect, useRef } from "react";
import wixLogo from "@/assets/Wix/wix-icon.png";
        ...
        <div className="min-h-screen bg-background overflow-hidden">
            ...
            <section className="relative w-full">
                ...
                <div className="relative z-10 flex flex-col items-center pt-32 sm:pt-40 px-4">
                    ...
                    >
                        Migrate from Wix to a site that can grow with you
                    </motion.h1>
                    ...
                    >
                        If you’ve outgrown Wix, we can guide you to a faster, more flexible platform like Webflow or Framer. We begin by mapping your existing site, redesigning the pages that matter most, and rebuilding everything in a modern, scalable stack. Throughout the migration, we carefully manage redirects and structure so both visitors and search engines clearly understand where your content has moved.
                    </motion.p>

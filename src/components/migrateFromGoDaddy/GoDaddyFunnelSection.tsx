...
import centralIcon from "@/assets/GoDaddy/godaddy-logo.webp";
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="text-center mb-10 md:mb-16 space-y-4 md:space-y-5">
                    <h2 className="section-title text-foreground">
                        Move from GoDaddy to a platform that can grow with you
                    </h2>
                    <p className="text-muted-foreground text-sm sm:text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
                        We help you transition from GoDaddy Website Builder to Webflow, Framer, or WordPress—prioritizing stronger design, better performance, and careful preservation of the traffic, rankings, and content you’ve already built.
                    </p>
                </div>
...
export default GoDaddyFunnelSection;

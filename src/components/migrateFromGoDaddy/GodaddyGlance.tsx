...
import godaddyGlance from "@/assets/GoDaddy/godaddy-logo.webp";
...
const features = [
    "Strategic redesign of core GoDaddy pages and layout structures",
    "Full rebuild in Webflow or Framer using a modern, scalable framework",
    "Carefully planned redirects to preserve SEO value and existing links",
];
                    ...
                    <div className="flex flex-col gap-6 lg:w-[45%] shrink-0">
                        ...
                        <div className="border-l-2 border-border pl-5">
                            <p className="text-muted-foreground leading-relaxed">
                                We partner with teams who began on GoDaddy for convenience and speed but now need greater flexibility in design, performance, and content management. Our aim is to deliver a site that keeps the original intent and clarity—while giving you far more control, scalability, and ease of maintenance as you grow.
                            </p>
                        </div>

...
import godaddyDashboardImg from "@/assets/GoDaddy/godaddy-project-ss.webp";
import { useEffect, useRef } from "react";
import godaddyLogo from "@/assets/GoDaddy/godaddy-logo.webp";
import godaddyBlankLogo from "@/assets/GoDaddy/logo-without-background.png";
    ...
    return (
        <div className="badge-frosted inline-flex items-center gap-2 px-3 py-1.5">
            ...
            <span className="text-sm font-medium text-foreground">
                GoDaddy to Webflow, Shopify & Framer
            </span>
        </div>
    );
};
        ...
        <div className="min-h-screen bg-background overflow-hidden">
            ...
            <section className="relative w-full">
                ...
                <div className="relative z-10 flex flex-col items-center pt-32 sm:pt-40 px-4">
                    ...
                    >
                        Migrate from GoDaddy to a more flexible site
                    </motion.h1>
                    ...
                    >
                        If your Elementor site has become slow, cluttered, or hard to maintain, we can help you regain control. We begin with a thorough audit to stabilize the existing setup, optimize performance, and improve the templates that matter most. When you're ready for a longer-term solution, we can migrate you to a cleaner, better-structured Webflow or WordPress build designed for speed, stability, and easier ongoing updates.
                    </motion.p>

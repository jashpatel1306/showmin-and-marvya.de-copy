...
const reasons: ReasonItem[] = [
    {
      title: "Proven experience migrating from GoDaddy",
      description:
        "We understand how GoDaddy sites are structured and how to transition them into Webflow, Framer, or WordPress while preserving the elements that already perform well.",
    },
    {
      title: "Integrated design and development",
      description:
        "We manage both the redesign and the rebuild, ensuring the final site feels cohesive and thoughtfully upgraded—not just a surface-level copy of the old version.",
    },
    {
    ...
    return (
        <section className="w-full bg-gradient-to-b from-secondary to-background py-16 md:py-24">
            <div className="mx-auto max-w-3xl px-4 md:px-6">
                ...
                Why work with Showmine on GoDaddy migration
                </h2>

...
import heroImg from "@/assets/CustomAiInterface/CustomAiInterface.png";
...
const deliverables = [
    {
        title: "Use case and content mapping",
        desc: "A concise document outlining the audience, key use cases, content sources, and boundaries for your AI interface.",
    },
    {
        title: "Conversation and interface design",
        desc: "Draft conversation flows, example dialogues, and UI guidance for how users start, interact with, and complete tasks.",
    },
    {
        title: "Model and knowledge configuration",
        desc: "Setup of how the assistant accesses and retrieves your content, including data sources, retrieval rules, and prompt structure.",
    },
    {
        title: "Guardrails and behavior rules",
        desc: "Defined limits for what the assistant can and cannot do, including fallback responses, refusal patterns, and human handoffs.",
    },
    {
        title: "Implementation support",
        desc: "Technical guidance and collaboration with your team or developers to integrate the interface into your website or internal tools.",
    },
    {
        title: "Analytics and improvement plan",
        desc: "Basic tracking setup with reports and recommendations to monitor usage, gather insights, and improve the assistant over time.",
    },
];
...
const processSteps = [
    {
        ...
        desc: "We start by understanding your goals, users, content, and tools, then define one or two focused use cases for the first version of the AI interface.",
    },
    {
        n: "2",
        title: "Content and interaction design",
        desc: "We map content sources, design conversation flows, define guardrails, and share example interactions for review.",
    },
    {
        n: "3",
        title: "Build and integration",
        desc: "We configure the AI system, connect your content, apply safety rules, and integrate the interface into your website or internal tools.",
    },
    {
        n: "4",
        title: "Testing and iteration",
        desc: "We test with real scenarios, refine behavior based on results, and launch with analytics and a roadmap for ongoing improvements.",
    },
];
...
const overviewSections = [
    {
        title: "AI Interfaces Built for Real Use Cases",
        body: `Many teams are interested in AI, but they don’t want another generic chat widget that nobody trusts. The real value comes from focused tools designed for specific tasks — answering questions about your services, helping teams find internal information, or triaging enquiries before they reach a human.
        
        We start with the use case, not the model. Together we define who the interface is for, what problem it should solve, and where it will live. A support assistant for your help center behaves very differently from an internal copilot for your sales team. By narrowing the scope, we build tools that are genuinely useful instead of generic bots that try to do everything.`,
        bullets: [],
    },
    {
        title: "Built on Your Content and Knowledge",
        body: `An AI assistant should understand your world and speak in your voice. To make that possible, we map the content and data it can safely use.
    ...
    {
        title: "Clear, On-Brand Experiences",
        body: `The interface matters as much as the AI behind it. We design the experience so it feels like a natural part of your product or website — not a bolted-on tool.
    ...
    {
        title: "Safety, Guardrails, and Control",
        body: `AI systems need clear boundaries. As part of every project, we define guardrails that guide how the assistant behaves.
        
        This includes`,
        bullets: [
            "Defining allowed and restricted topics",
            "Handling sensitive or uncertain questions",
            "Preventing fabricated answers",
...

    {
        ...
        body: `AI becomes far more useful when it connects to your existing systems.
                
        Depending on your workflow, this could include.`,
        bullets: [
            "Surfacing relevant pages from your website",
            "Creating support tickets or drafts",
            "Sending qualified enquiries to your CRM",
            "Logging conversations for team insights"
        ],
    },

    {
        title: "Designed to Improve Over Time",
        body: `A good AI interface should continuously improve. We build simple systems that allow you to review how the assistant is performing.
        
        This can include:`,
        bullets: [
            "Conversation logs and transcripts",
            "Reports on common questions",
    ...
    return (
        <div className="space-y-8">
            ...
            <p className="text-[15px] leading-relaxed text-foreground">
                We design and develop custom AI interfaces built around your real content and workflows. The result is an on-brand assistant that can answer questions, surface knowledge, and operate within carefully defined guardrails.
            </p>
            {/* Category + Tools */}

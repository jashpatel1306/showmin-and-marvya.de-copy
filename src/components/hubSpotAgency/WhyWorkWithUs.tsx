...
const reasons: ReasonItem[] = [
    {
        title: "Websites, funnels, and CRM aligned",
        description:
            "We handle website builds, funnel strategy, and HubSpot configuration together—so tracking, data flow, and reporting are connected from the start.",
    },
    {
        title: "HubSpot built for real-world use",
        description:
            "We prioritize the features that match your stage and goals, avoiding unnecessary complexity so your team can confidently use HubSpot every day.",
    },
    {
        title: "Ongoing support as you scale",
        description:
            "As your offers, team structure, or marketing channels grow, we refine pipelines, workflows, and reporting to ensure HubSpot continues to support your progress.",
    },
];
        ...
        <section className="w-full bg-gradient-to-b from-secondary to-background py-16 md:py-24">
            <div className="mx-auto max-w-3xl px-4 md:px-6">
                <h2 className="section-title text-foreground text-center mb-12">
                    Why work with a HubSpot agency like Showmine
                </h2>

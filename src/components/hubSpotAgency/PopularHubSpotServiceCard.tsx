...
const popularServices = [
  {
    ...
    description: "Capture, route and follow up consistently",
    href: "/landing",
    accent: "yellow" as const,
  },
  {
    title: "Email automation",
    description: "Thoughtful email journeys to inform and push to the next step",
    href: "/services/figma-to-webflow-development",
    accent: "blue" as const,
  },
  {
    title: "Zapier automation",
    description: "Practical Zapier automation setup",
    href: "/services/technical-seo-audit",
    accent: "green" as const,
  },
  {
    title: "AI content workflow",
    description: "Strategy and setup for AI assisted content workflows",
    href: "/services/custom-ai-interface",
    accent: "purple" as const,
  },
  {
    title: "Chatbot setup",
    description: "Answer common questions & capture leads",
    href: "/services/web-design",
    accent: "yellow" as const,
  },
  {
    title: "Case-study writing",
    description: "Turn real client projects into captivating stories",
    href: "/services/plugin-updates",
    accent: "coral" as const,
  },
];

const PopularHubSpotServiceCard = () => {
  return (
    <section className="max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-24 bg-background">
      ...
      Services for HubSpot CRM and funnels
      </h2>
...
export default PopularHubSpotServiceCard;

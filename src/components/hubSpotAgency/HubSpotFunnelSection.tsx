...
import centralIcon from "@/assets/HubSpotAgency/hubspot.jpg";
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="text-center mb-10 md:mb-16 space-y-4 md:space-y-5">
                    <h2 className="section-title text-foreground">
                        Turn HubSpot into your single source of truth
                    </h2>
                    <p className="text-muted-foreground text-sm sm:text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
                        We help you structure HubSpot so website leads, deals, and email activity come together in one clear system giving you visibility into what’s working and where to improve.
                    </p>
                </div>
...
export default HubSpotFunnelSection;

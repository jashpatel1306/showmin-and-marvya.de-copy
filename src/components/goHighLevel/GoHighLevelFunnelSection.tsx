...
import centralIcon from "@/assets/Gohighlevel/gohighlevel-logo.jpg";
...
const GoHighLevelFunnelSection = () => {
    return (
        <section className="max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-16">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="text-center mb-10 md:mb-16 space-y-4 md:space-y-5">
                    ...
                    Make GoHighLevel the hub for your funnels
                    </h2>
                    <p className="text-muted-foreground text-sm sm:text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
                    We help you turn GoHighLevel into the central hub where ads, landing pages, bookings, and follow-up all connect, so you can see the full journey clearly and improve performance at every stage.
                    </p>
                </div>
...
export default GoHighLevelFunnelSection;

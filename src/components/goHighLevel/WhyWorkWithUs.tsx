...
const reasons: ReasonItem[] = [
    {
      title: "Websites, funnels, and GoHighLevel aligned",
      description:
        "We design and build websites, funnels, and GoHighLevel journeys together, helping you decide what belongs where and ensuring everything feels connected.",
    },
    {
      title: "Built with conversion in mind",
      description:
        "We prioritize clarity, performance, and structure so your GoHighLevel pages feel credible and convert more visitors into leads and bookings.",
    },
    {
      title: "Ongoing optimization and support",
      description:
        "After launch, we help refine funnels, launch new campaigns, and keep your GoHighLevel setup organized as your business grows.",
    },
  ];
    ...
    return (
        <section className="w-full bg-gradient-to-b from-secondary to-background py-16 md:py-24">
            <div className="mx-auto max-w-3xl px-4 md:px-6">
                ...
                Why work with a GoHighLevel (GHL) agency like Showmine
                </h2>

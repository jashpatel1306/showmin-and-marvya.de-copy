...
import dashboardImg from "@/assets/Gohighlevel/gohighlevel-project-ss.png";
import { useRef, useEffect } from "react";
import goHighLevelLogo from "@/assets/Gohighlevel/gohighlevel-logo.jpg";
import goHighLevelLogoWithOutBG from "@/assets/Gohighlevel/gohighlevel-without-bg.png"
...
const HeroBadge = () => {
    return (
        <div className="badge-frosted inline-flex items-center gap-2 px-3 py-1.5">
            <img
                src={goHighLevelLogoWithOutBG}
                alt="HubSpot"
                className="w-3 h-3 object-cover"
            />
            <span className="text-sm font-medium text-foreground">
                GoHighLevel funnel experts
            </span>
        </div>
    );
};
        ...
        <div className="min-h-screen bg-background overflow-hidden">
            ...
            <section className="relative w-full">
                ...
                <div className="relative z-10 flex flex-col items-center pt-32 sm:pt-40 px-4">
                    ...
                    >
                        GoHighLevel agency for funnels and sites
                    </motion.h1>
                    ...
                    >
                        We design and build GoHighLevel funnels and websites that are clear, fast-loading, and seamlessly connected to your pipelines, calendars, and automations. The result is a smooth experience for your users and a setup that’s straightforward for your team to manage.
                    </motion.p>

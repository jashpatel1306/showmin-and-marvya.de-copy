...
import goHighLevelGlance from "@/assets/Gohighlevel/gohighlevel-logo.jpg";
...
const cards = [
    {
      ...
      description:
        "Lead generation funnels, streamlined authority websites, booking workflows, nurture sequences, and multi-step campaigns built directly within GoHighLevel.",
      borderClass: "border-r border-b",
    },
    {
      title: "Best for teams that",
      description:
        "Prefer to manage their website, funnels, CRM, and automations in one unified platform rather than juggling multiple disconnected tools.",
      borderClass: "border-l border-b",
    },
    {
      title: "Typical results",
      description:
        "More structured funnels, clearer customer journeys, and fewer leads lost between ads, landing pages, and follow-up sequences.",
      borderClass: "border-r border-t",
    },
    {
      title: "What we build in GoHighLevel",
      description:
        "Landing pages, full websites, funnel flows, booking systems, pipelines, core automations, and integrations with forms, email, and SMS.",
      borderClass: "border-l border-t",
    },
  ];

const features = [
  "Conversion-focused funnels and websites",
  "Built natively inside GoHighLevel, not layered on top",
  "ClSeamlessly connected to your pipelines, calendars, and automations",
];
                ...
                <div className="flex flex-col lg:flex-row gap-10 lg:gap-16">
                    ...
                    <div className="flex flex-col gap-6 lg:w-[45%] shrink-0">
                        ...
                        <div className="flex items-center gap-4">
                            <img
                                src={goHighLevelGlance}
                                alt="A glance at GoHighLevel"
                                className="w-14 h-14 rounded-lg object-cover"
                            />
                            <h2 className="text-2xl sm:text-3xl font-semibold text-foreground">
                            A glance at GoHighLevel
                            </h2>
                        </div>
                        ...
                        <div className="border-l-2 border-border pl-5">
                            ...
                            We use GoHighLevel when you need funnels, websites, and follow-up sequences working together in one platform from the first click through to a booked call and ongoing nurture.
                            </p>
                        </div>
...
export default GoHighLevelGlance;

// Loveable desing inprogess in this page on vedalook account.
...
import HeroCanvas from "@/components/design/HeroCanvas";
import designCanvasImg from "@/assets/Design/design-canvas.png";
import CreativesSection from "@/components/design/CreativesSection";
import PurposeSection from "@/components/design/PurposeSection";
import TrustedBy from "@/components/TrustedBy";
import RecentDesign from "@/components/design/RecentDesign";
          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-14 items-start">
            ...
            >
              ...
              <p className="max-w-md text-base leading-relaxed text-muted-foreground md:text-lg">
                Showmine partners with ambitious teams to create thoughtful product and website designs.
              </p>
